...
<main class="contenedor seccion">
    ...
    <!-- Enviar los datos al script PHP 'procesar_contacto.php' -->
    <form class="formulario" method="POST" action="/bienesraices_inicio/procesar_contacto.php">
        <fieldset>
        ...
        <fieldset>
            ...
            <input type="number" name="presupuesto" placeholder="Tu Precio o Presupuesto" id="presupuesto">
        </fieldset>
